...
var AppKit = class extends AppKitBaseClient {
  ...
  async loadModalComponents(features, remoteFeatures) {
    ...
    if (usingEmbeddedWallet) {
      featureImportPromises.push(import("./embedded-wallet-5VRPUD3Z.js"));
    }
    if (remoteFeatures.email) {
      featureImportPromises.push(import("./email-PYZLK3VO.js"));
    }
    if (remoteFeatures.socials) {
      featureImportPromises.push(import("./socials-PQOX4W4J.js"));
    }
    if (remoteFeatures.swaps && remoteFeatures.swaps.length > 0) {
      featureImportPromises.push(import("./swaps-6LM5QT2N.js"));
    }
    if (features.send) {
      featureImportPromises.push(import("./send-TQEKBF6K.js"));
    }
    if (features.receive) {
      featureImportPromises.push(import("./receive-2YCEHPNV.js"));
    }
    if (remoteFeatures.onramp && remoteFeatures.onramp.length > 0) {
      featureImportPromises.push(import("./onramp-GOODULXC.js"));
    }
    if (remoteFeatures.activity) {
      featureImportPromises.push(import("./transactions-74N5YVTB.js"));
    }
    if (features.pay) {
      featureImportPromises.push(import("./exports-UHXKEJPM.js"));
    }
    if (remoteFeatures.emailCapture) {
      featureImportPromises.push(import("./ui-MECR7OK5.js"));
    }
    await Promise.all([
      ...featureImportPromises,
      import("./exports-E3TTEUAG.js"),
      import("./w3m-modal-HUDHIQZN.js")
    ]);
  }
};
...
//# sourceMappingURL=exports-ZLL7SUJX.js.map
